...
:disabled="stat.peminjamanAktif<=0">-</button>
 ...
 <div class="computed-info">
  ...
  <div class="pbar">
    <div class="pbar-fill" :style="{ width: persenTersedia }"></div>
  </div>
</div>
 </section>
 <!-- NOTIFIKASI TOAST -->
...
.ctrl-group label { display: block; font-weight: 600; color: #475569; marginbottom: 8px; }
...
.ctrl span { font-size: 1.5rem; font-weight: 700; min-width: 60px; textalign: center; }
