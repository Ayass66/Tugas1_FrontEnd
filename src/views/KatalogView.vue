...
.btn-clear { position:absolute; right:8px; top:50%; transform:translateY(-
50%);
 background:none; border:none; color:#94A3B8; cursor:pointer; fontsize:1rem; }
.select-filter { padding:10px 12px; border:1px solid #CBD5E1; borderradius:8px;
...
/* Grid buku */
.grid-buku { display:grid; grid-template-columns:repeat(autofill,minmax(240px,1fr));
 gap:20px; }
...
#E2E8F0;
 border-radius:12px; padding:20px; display:flex; gap:16px; alignitems:center;
 flex-wrap:wrap; }
