    ...
    <header class="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur">
      <div class="container mx-auto px-4 max-w-7xl">
        <div class="flex h-16 items-center justify-between">
          ...
          <!-- Logo -->
          <RouterLink to="/" class="flex items-center gap-2 font-bold text-xl text-foreground">
          ...
          <nav class="hidden md:flex items-center gap-1">
            <RouterLink
              ...
              class="inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium transition-colors hover:bg-accent"
            >
      ...
      <div v-show="isMobileMenuOpen" class="md:hidden border-t border-border bg-background">
        <nav class="container mx-auto px-4 py-4 space-y-1">
          ...
          <RouterLink
            ...
            :to="item.path"
            active-class="bg-accent text-accent-foreground"
            class="flex items-center gap-3 rounded-lg px-3 py-2 text-base font-medium transition-colors hover:bg-accent"
